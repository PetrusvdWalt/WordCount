...
public interface WordFrequencyAnalyzer {
     ...
     *
     * @param text Incoming text to check for the frequencies. This text will be sorted by these values as word ends:  ;:-,[].()"'“?
     * @param n    How many results to return.
     * @return     A list with WordFrequency object with the first N most frequent words in the text.
